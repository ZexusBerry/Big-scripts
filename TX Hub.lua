...
local function CreateLabel(text, position)
	...
	label.BackgroundTransparency = 1 -- Делаем фон прозрачным
	label.Font = Enum.Font.SourceSansBold
	label.TextColor3 = Color3.fromRGB(50, 168, 82)
	label.TextSize = 23
...
local Label1 = CreateLabel("FX Hub", UDim2.new(0.5, 0, 0, 0))
local Button1 = CreateButton("Hoop Farm", UDim2.new(0.5, 0, 0.11, 0))
local Button2 = CreateButton("Get All Gems in map", UDim2.new(0.5, 0, 0.23, 0))
local Button3 = CreateButton("Get All Orbs in map", UDim2.new(0.5, 0, 0.35, 0))
local Button4 = CreateButton("Super Fast Farm Gem", UDim2.new(0.5, 0, 0.47, 0))
local Button5 = CreateButton("Super Fast Farm Orbs", UDim2.new(0.5, 0, 0.59, 0))
